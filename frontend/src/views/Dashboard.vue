<template>
  <div class="px-4 py-6 sm:px-0">
    <div class="border-4 border-dashed border-gray-200 rounded-lg p-4 mb-6">
      <h1 class="text-3xl font-bold text-gray-900 mb-4">Dashboard</h1>
      
      <!-- Date Range Filter -->
      <div class="mb-6 bg-white rounded-lg p-4 shadow">
        <h2 class="text-lg font-medium text-gray-900 mb-3">Filter by Date Range</h2>
      ...
      <div v-if="inventoryStatus?.low_stock_items?.length > 0" class="mb-8">
        <div class="card border-l-4 border-red-500">
          ...
          <div class="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3">
            <div 
              v-for="item in inventoryStatus.low_stock_items" 
              :key="`${item.branch_name}-${item.item_name}`"
      ...
      <div class="mb-8">
        <div class="card">
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div 
              v-for="branch in inventoryStatus?.branch_inventory_summary" 
              :key="branch.id"
...
import type { DashboardSummary, TopItem, BranchRevenue } from '@/types'
